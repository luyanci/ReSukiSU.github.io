import{_ as d,I as e,o as r,c as E,j as i,a,J as n,w as o,ab as l}from"./chunks/framework.CEw9AoTv.js";const w=JSON.parse('{"title":"Manual Integrate reference","description":"","frontmatter":{},"headers":[],"relativePath":"guide/manual-integrate.md","filePath":"guide/manual-integrate.md"}'),g={name:"guide/manual-integrate.md"},c={class:"info custom-block"},_={id:"generic-hooks",tabindex:"-1"},u={id:"faccessat-hook",tabindex:"-1"},y={id:"sys-reboot-hook",tabindex:"-1"},f={id:"input-hooks",tabindex:"-1"},b={id:"setuid-hooks",tabindex:"-1"},A={id:"sys-read-hook",tabindex:"-1"},m={id:"how-to-backport-path-umount",tabindex:"-1"};function D(v,s,C,F,O,N){const p=e("CopyOrDownloadAsMarkdownButtons"),h=e("VPNolebaseInlineLinkPreview"),t=e("Badge"),k=e("NolebaseGitChangelog");return r(),E("div",{"data-pagefind-body":!0,"data-pagefind-meta":"date:1772251583000"},[s[26]||(s[26]=i("div",{style:{display:"none"},hidden:"true","aria-hidden":"true"},"Are you an LLM? You can read better optimized documentation at /guide/manual-integrate.md for this page in Markdown format",-1)),s[27]||(s[27]=i("h1",{id:"hooks",tabindex:"-1"},[a("Manual Integrate reference "),i("a",{class:"header-anchor",href:"#hooks","aria-label":"Permalink to “Manual Integrate reference”"},"​")],-1)),n(p),s[28]||(s[28]=i("h2",{id:"manual-hooks",tabindex:"-1"},[a("Manual hooks "),i("a",{class:"header-anchor",href:"#manual-hooks","aria-label":"Permalink to “Manual hooks”"},"​")],-1)),s[29]||(s[29]=i("div",{class:"danger custom-block"},[i("p",{class:"custom-block-title"},"Notice："),i("p",null,[a("ReSukiSU will check every hook here, and if any are missing, it will "),i("strong",null,"cause compilation to fail"),a(".")])],-1)),i("div",c,[s[2]||(s[2]=i("p",{class:"custom-block-title"},"info",-1)),i("p",null,[s[1]||(s[1]=a("The hook in this part is adapted from ",-1)),n(h,{href:"https://github.com/backslashxx/KernelSU/issues/5",target:"_blank",rel:"noreferrer"},{default:o(()=>[...s[0]||(s[0]=[i("code",null,"backslashxx/KernelSU #5",-1)])]),_:1})])]),i("h3",_,[s[3]||(s[3]=a("generic hooks ",-1)),n(t,{type:"danger",text:"Required"}),s[4]||(s[4]=a()),s[5]||(s[5]=i("a",{class:"header-anchor",href:"#generic-hooks","aria-label":"Permalink to “generic hooks”"},"​",-1))]),s[30]||(s[30]=l(`<div class="vp-code-group"><div class="tabs"><input type="radio" name="group-21" id="tab-22" checked><label data-title="exec.c" for="tab-22">exec.c</label><input type="radio" name="group-21" id="tab-23"><label data-title="stat.c" for="tab-23">stat.c</label></div><div class="blocks"><div class="language-diff active"><button title="Copy Code" class="copy"></button><span class="lang">diff</span><pre class="shiki shiki-themes github-light github-dark" style="--shiki-light:#24292e;--shiki-dark:#e1e4e8;--shiki-light-bg:#fff;--shiki-dark-bg:#24292e;" tabindex="0" dir="ltr"><code><span class="line"><span style="--shiki-light:#B31D28;--shiki-dark:#FDAEB7;">--- a/fs/exec.c</span></span>
...
<span class="line"><span style="--shiki-light:#22863A;--shiki-dark:#85E89D;">+#endif</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">	return error;</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">}</span></span></code></pre></div></div></div>`,1)),i("h3",u,[s[6]||(s[6]=a("faccessat hook ",-1)),n(t,{type:"danger",text:"Required"}),s[7]||(s[7]=a()),s[8]||(s[8]=i("a",{class:"header-anchor",href:"#faccessat-hook","aria-label":"Permalink to “faccessat hook”"},"​",-1))]),s[31]||(s[31]=l(`<p>For this hook, different kernel versions are inconsistent, so it is explained separately here</p><div class="vp-code-group"><div class="tabs"><input type="radio" name="group-31" id="tab-32" checked><label data-title="4.19+" for="tab-32">4.19+</label><input type="radio" name="group-31" id="tab-33"><label data-title="4.19-" for="tab-33">4.19-</label></div><div class="blocks"><div class="language-diff active"><button title="Copy Code" class="copy"></button><span class="lang">diff</span><pre class="shiki shiki-themes github-light github-dark" style="--shiki-light:#24292e;--shiki-dark:#e1e4e8;--shiki-light-bg:#fff;--shiki-dark-bg:#24292e;" tabindex="0" dir="ltr"><code><span class="line"><span style="--shiki-light:#B31D28;--shiki-dark:#FDAEB7;">--- a/fs/open.c</span></span>
...
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> 		ret = vfs_read(f.file, buf, count, &amp;pos);</span></span></code></pre></div></div></div>`,2)),i("h2",m,[s[23]||(s[23]=a("path_umount ",-1)),n(t,{type:"info",text:"Optional"}),s[24]||(s[24]=a()),s[25]||(s[25]=i("a",{class:"header-anchor",href:"#how-to-backport-path-umount","aria-label":"Permalink to “path_umount”"},"​",-1))]),s[36]||(s[36]=l(`<div class="info custom-block"><p class="custom-block-title">Notes</p><p>This is an optional patch，you don&#39;t need to apply this one.</p></div><p>You can make the &quot;Umount modules&quot; feature work on pre-GKI kernels by manually backporting <code>path_umount</code> from 5.9. You can use this patch as reference:</p><div class="language-diff"><button title="Copy Code" class="copy"></button><span class="lang">diff</span><pre class="shiki shiki-themes github-light github-dark" style="--shiki-light:#24292e;--shiki-dark:#e1e4e8;--shiki-light-bg:#fff;--shiki-dark-bg:#24292e;" tabindex="0" dir="ltr"><code><span class="line"><span style="--shiki-light:#B31D28;--shiki-dark:#FDAEB7;">--- a/fs/namespace.c</span></span>
...
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">  * This is important for filesystems which use unnamed block devices.</span></span></code></pre></div>`,3)),n(k)])}const T=d(g,[["render",D]]);export{w as __pageData,T as default};
